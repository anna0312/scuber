...
var config = {
  apiOrigins: {
    production: 'https://afternoon-basin-31565.herokuapp.com',
...
var displayMessage = function displayMessage(id, message, css) {
  $('#' + id).html(message);
  $('#' + id).addClass(css);
...
var diveEvents = __webpack_require__(18);
$(function () {
...
var onChangePassword = function onChangePassword(event) {
  event.preventDefault();
  var data = getFormFields(event.target); // event.target is same as "this" used above
...
var onLogout = function onLogout() {
  ...
  api.logOut().then(ui.signOutSuccess).catch(ui.signOutFailure);
};
...
var pageLoadEvents = function pageLoadEvents() {
  ui.updateAuthLayout();
};
...
var signUpFailPwdMatch = function signUpFailPwdMatch() {
...
var updateAuthLayout = function updateAuthLayout() {
...
module.exports = {
  ...
  updateAuthLayout: updateAuthLayout,
  signUpFailPwdMatch: signUpFailPwdMatch,
...
var onShowDives = function onShowDives() {
  event.preventDefault();
  api.getDives().then(ui.getDivesSuccess).catch(ui.generalFailure);
};

var onShowCreateDive = function onShowCreateDive() {
  event.preventDefault();
  ui.showCreateDive();
};

var onShowUpdateDive = function onShowUpdateDive(event) {
  event.preventDefault();
  api.getDive($(event.target).data('diveid')).then(ui.showUpdateDive).catch(ui.generalFailure);
};

var onCreateDive = function onCreateDive(event) {
  // prevent default action of page loading
  event.preventDefault();
  var data = getFormFields(this);
  api.createDive(data).then(ui.createDiveSuccess, onShowDives()).catch(ui.createDiveFailure);
};

var onUpdateDive = function onUpdateDive(event) {
  event.preventDefault();
  var data = getFormFields(this); // event.target is same as "this" used above
  api.updateDive(data).then(ui.updateDiveSuccess).catch(ui.generalFailure);
};

var onDeleteDive = function onDeleteDive(event) {
  event.preventDefault();
  api.deleteDive($(event.target).data('diveid')).then(ui.deleteDiveSuccess).catch(ui.generalFailure);
  onShowDives();
};
...
var getDives = function getDives(data) {
...
var getDive = function getDive(id) {
  return $.ajax({
...
var createDive = function createDive(data) {
  return $.ajax({
    url: config.apiOrigin + '/dives/',
    method: 'POST',
    headers: {
...
var updateDive = function updateDive(data) {
  return $.ajax({
...
var deleteDive = function deleteDive(id) {
...
var helpers = __webpack_require__(8);
var showDivesTemplate = __webpack_require__(21);
var createDiveFormTemplate = __webpack_require__(38);
var updateDiveFormTemplate = __webpack_require__(39);

var clearFields = function clearFields() {};

var getDivesSuccess = function getDivesSuccess(data) {
  var showDivesHtml = showDivesTemplate({ dives: data.dives });
  helpers.displayMessage('message', '');
  $('#primary-content').html(showDivesHtml);
};

var showCreateDive = function showCreateDive(data) {
  var showCreateDiveFormHtml = createDiveFormTemplate();
  $('#primary-content').html(showCreateDiveFormHtml);
};

var showUpdateDive = function showUpdateDive(data) {
  var showUpdateDiveFormHtml = updateDiveFormTemplate({ dive: data.dive });
  $('#primary-content').html(showUpdateDiveFormHtml);
};

var updateDiveSuccess = function updateDiveSuccess(data) {
  helpers.displayMessage('message', 'Dive updated successfully. Click "See your dives" to refresh the list');
};

var deleteDiveSuccess = function deleteDiveSuccess(diveID) {
  helpers.displayMessage('message', 'Dive deleted. Click "See your dives" to refresh the list');
};

var createDiveSuccess = function createDiveSuccess(data) {
  helpers.displayMessage('message', 'Dive saved. Click "See your dives" to refresh the list');
};

var createDiveFailure = function createDiveFailure(error) {
  //  $('#authResponse').text('Error on signing up')
  //  $('#authResponse').css('background-color', 'red')
...
var generalFailure = function generalFailure(error) {
  helpers.displayMessage('message', 'Yikes! Something went horribly awry!');
  console.error(error);
};

module.exports = {
  getDivesSuccess: getDivesSuccess,
  showCreateDive: showCreateDive,
  showUpdateDive: showUpdateDive,
  updateDiveSuccess: updateDiveSuccess,
  deleteDiveSuccess: deleteDiveSuccess,
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<div class=\"panel-group\" id=\"dives-accordion\" style=\"margin-top: 15px;\">\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.dives : depth0),{"name":"each","hash":{},"fn":container.program(2, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "\n</div>\n";
},"2":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1, alias1=container.lambda, alias2=container.escapeExpression;

  return "    <div class=\"panel panel-default\" data-panelDivID=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n      <div class=\"panel-heading\">\n        <h4 class=\"panel-title\">\n        <a data-toggle=\"collapse\" data-parent=\"#dives-accordion\" href=\"#dive"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n          "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.location : stack1), depth0))
    + "\n        </a>\n      </h4>\n      </div>\n      <div id=\"dive"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"panel-collapse collapse\">\n        <div class=\"panel-body\">\n\n              <label class=\"show-dives-label\">Date</label>\n              "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.date : stack1), depth0))
    + "\n\n              <label class=\"show-dives-label\">Duration:</label>\n              "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.duration : stack1), depth0))
    + "\n\n          <br />\n\n\n              <label class=\"show-dives-label\">Maximum depth:</label>\n              "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.max_depth : stack1), depth0))
    + "\n\n\n              <label class=\"show-dives-label\">PSI Used:</label>\n              "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.psi_used : stack1), depth0))
    + "\n\n              <label class=\"show-dives-label\">Weights worn:</label>\n              "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.weights_worn : stack1), depth0))
    + "\n          <br />\n          <label class=\"show-dives-label\">Notes:</label>\n          "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.notes : stack1), depth0))
    + "\n\n\n<!--\n              <label class=\"show-dives-label\">Rating: </label>\n              "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.rating : stack1), depth0))
    + "\n\n              <label class=\"show-dives-label\">Settings:</label>\n"
    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = blockParams[0][0]) != null ? stack1.make_public : stack1),{"name":"if","hash":{},"fn":container.program(3, data, 0, blockParams),"inverse":container.program(5, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "            -->\n\n<br />\n<button class=\"btn btn-info btn-update-dive\" data-diveid=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">Edit this record</button>\n<button class=\"btn btn-danger btn-delete-dive\" data-diveid=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">Delete this dive</button>\n        </div>\n      </div>\n    </div>\n";
},"3":function(container,depth0,helpers,partials,data) {
    return "                Public\n";
},"5":function(container,depth0,helpers,partials,data) {
    return "                Private\n";
},"7":function(container,depth0,helpers,partials,data) {
    return "<div class=\"message\">You have not logged any dives yet!</div>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.dives : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0, blockParams),"inverse":container.program(7, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "\n\n<h2 class=\"titleText\">Log a dive</h2>\n<form id=\"create-dive\" role=\"form\">\n\n  <div class=\"form-group\">\n    <label>Location</label>\n    <input type=\"text\" class=\"form-control\" id=\"location\" name=\"dive[location]\" placeholder=\"Location\" required>\n  </div>\n  <div class=\"row\">\n    <div class=\"col-xs-6\">\n      <div class=\"form-group\">\n        <label>Date</label>\n        <input type=\"date\" class=\"form-control\" id=\"date\" name=\"dive[date]\" placeholder=\"date\" required>\n      </div>\n    </div>\n    <div class=\"col-xs-6\">\n      <div class=\"form-group\">\n        <label>Duration</label>\n        <input type=\"number\" min=\"0\" class=\"form-control\" id=\"duration\" name=\"dive[duration]\" placeholder=\"Duration (in minutes)\">\n      </div>\n    </div>\n  </div>\n\n  <div class=\"row\">\n    <div class=\"col-xs-4\">\n      <div class=\"form-group\">\n        <label>Max depth</label>\n        <input type=\"number\" min=\"0\" class=\"form-control\" id=\"max_depth\" name=\"dive[max_depth]\" placeholder=\"In feet\">\n      </div>\n    </div>\n    <div class=\"col-xs-4\">\n      <div class=\"form-group\">\n        <label>PSI Used</label>\n        <input type=\"number\" min=\"0\" class=\"form-control\" id=\"psi_used\" name=\"dive[psi_used]\" placeholder=\"PSI\">\n      </div>\n    </div>\n    <div class=\"col-xs-4\">\n      <div class=\"form-group\">\n        <label>Weights worn</label>\n        <input type=\"number\" min=\"0\" class=\"form-control\" id=\"weight_used\" name=\"dive[weight_used]\" placeholder=\"In lbs\">\n      </div>\n    </div>\n  </div>\n  <div class=\"form-group\">\n    <label>Anything of note?</label>\n    <textarea class=\"form-control\" id=\"notes\" name=\"dive[notes]\" placeholder=\"Anything special to report?\"></textarea>\n  </div>\n  <!--\n  <div class=\"row\">\n    <div class=\"col-xs-6\">\n      <div class=\"form-group\">\n        <label>How was it?</label>\n        <select class=\"form-control\" id=\"rating\" name=\"dive[rating]\">\n        <option value=\"5\">Amazing!</option>\n        <option value=\"4\">Pretty dern good</option>\n        <option value=\"3\">Wasn't the worst. Wasn't the best.</option>\n        <option value=\"2\">At least I didn't run out of air</option>\n        <option value=\"1\">Worse than running out of air</option>\n      </select>\n      </div>\n    </div>\n    <div class=\"col-xs-6\">\n      <div class=\"form-group\">\n        <label>Care to share?</label>\n        <select name=\"dive[make_public]\" class=\"form-control\">\n        <option value=\"1\">Public</option>\n        <option value=\"0\">Private</option>\n      </select>\n      </div>\n    </div>\n  </div>\n-->\n\n  <input type=\"submit\" class=\"btn btn-info\" id=\"submit-create-dive\" value=\"Save my dive\">\n</form>\n";
},"useData":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "\n<h2 class=\"titleText\">Updating: Dive "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.dive : depth0)) != null ? stack1.id : stack1), depth0))
    + "</h2>\n<form id=\"update-dive\" role=\"form\">\n  <input type=\"hidden\" name=\"dive[id]\" value=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.dive : depth0)) != null ? stack1.id : stack1), depth0))
    + "\">\n  <div class=\"form-group\">\n    <label>Location</label>\n    <input type=\"text\" class=\"form-control\" id=\"location\" name=\"dive[location]\" placeholder=\"Location\" value=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.dive : depth0)) != null ? stack1.location : stack1), depth0))
    + "\" required>\n  </div>\n  <div class=\"row\">\n    <div class=\"col-xs-6\">\n      <div class=\"form-group\">\n        <label>Date</label>\n        <input type=\"date\" class=\"form-control\" id=\"date\" name=\"dive[date]\" placeholder=\"date\" value=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.dive : depth0)) != null ? stack1.date : stack1), depth0))
    + "\" required>\n      </div>\n    </div>\n    <div class=\"col-xs-6\">\n      <div class=\"form-group\">\n        <label>Duration</label>\n        <input type=\"number\" min=\"0\" class=\"form-control\" id=\"duration\" name=\"dive[duration]\" placeholder=\"Duration (in minutes)\"  value=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.dive : depth0)) != null ? stack1.duration : stack1), depth0))
    + "\">\n      </div>\n    </div>\n  </div>\n\n  <div class=\"row\">\n    <div class=\"col-xs-4\">\n      <div class=\"form-group\">\n        <label>Max depth</label>\n        <input type=\"number\" min=\"0\" class=\"form-control\" id=\"max_depth\" name=\"dive[max_depth]\" placeholder=\"In feet\" value=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.dive : depth0)) != null ? stack1.max_depth : stack1), depth0))
    + "\">\n      </div>\n    </div>\n    <div class=\"col-xs-4\">\n      <div class=\"form-group\">\n        <label>PSI Used</label>\n        <input type=\"number\" min=\"0\" class=\"form-control\" id=\"psi_used\" name=\"dive[psi_used]\" placeholder=\"PSI\" value=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.dive : depth0)) != null ? stack1.psi_used : stack1), depth0))
    + "\">\n      </div>\n    </div>\n    <div class=\"col-xs-4\">\n      <div class=\"form-group\">\n        <label>Weights worn</label>\n        <input type=\"number\" min=\"0\" class=\"form-control\" id=\"weight_used\" name=\"dive[weight_used]\" placeholder=\"In lbs\" value=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.dive : depth0)) != null ? stack1.weight_used : stack1), depth0))
    + "\">\n      </div>\n    </div>\n  </div>\n  <div class=\"form-group\">\n    <label>Anything of note?</label>\n    <textarea class=\"form-control\" id=\"notes\" name=\"dive[notes]\" placeholder=\"Anything special to report?\">"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.dive : depth0)) != null ? stack1.notes : stack1), depth0))
    + "</textarea>\n  </div>\n<!--\n  <div class=\"row\">\n    <div class=\"col-xs-6\">\n      <div class=\"form-group\">\n        <label>How was it?</label>\n        <select class=\"form-control\" id=\"rating\" name=\"dive[rating]\">\n        <option value=\"5\">Amazing!</option>\n        <option value=\"4\">Pretty dern good</option>\n        <option value=\"3\">Wasn't the worst. Wasn't the best.</option>\n        <option value=\"2\">At least I didn't run out of air</option>\n        <option value=\"1\">Worse than running out of air</option>\n      </select>\n      </div>\n    </div>\n    <div class=\"col-xs-6\">\n      <div class=\"form-group\">\n        <label>Care to share?</label>\n        <select name=\"dive[make_public]\" class=\"form-control\">\n        <option value=\"1\">Public</option>\n        <option value=\"0\">Private</option>\n      </select>\n      </div>\n    </div>\n  </div>\n-->\n\n  <input type=\"submit\" class=\"btn btn-info\" id=\"submit-update-dive\" value=\"Save my changes\">\n</form>\n";
},"useData":true});
